...
local Window = Fluent:CreateWindow({Title = "Slayer Hub",SubTitle = "by FJN",TabWidth = 155,Size = UDim2.fromOffset(555, 320),Acrylic = false,Theme = "AMETHYST",MinimizeKey = Enum.KeyCode.End})
local Tabs = {
...
local FarmLevel = Tabs.Main:AddToggle("FarmLevel", {Title = "Auto Level", Description = "", Default = false})
