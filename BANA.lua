if game:GetService("CoreGui"):FindFirstChild('Slayer Hub') then
    game:GetService("CoreGui"):FindFirstChild('Slayer Hub'):Destroy()
end

-- Slayer Hub principal
local SlayerHub = Instance.new("ScreenGui")
SlayerHub.Name = "Slayer Hub"
SlayerHub.Parent = game:GetService("CoreGui")
SlayerHub.Enabled = false

-- Esconder HUDs do jogador
local player = game:GetService("Players").LocalPlayer
player.PlayerGui.Main.BottomHUDList.SafeZone.Visible = false
player.PlayerGui.Main.Code.Visible = false

-- Frame Level
local F_Level = Instance.new("Frame")
F_Level.Name = "Level"
F_Level.Parent = SlayerHub
...
player.PlayerGui.Main.Fragments:Clone().Parent = F_Level
F_Level.Fragments.TextColor3 = Color3.fromRGB(0, 255, 186)
F_Level.Fragments.Text = "Slayer Hub"
F_Level.Fragments.Size = UDim2.new(1, 0, 0, 40)
F_Level.Fragments.TextXAlignment = 'Center'
F_Level.Position = UDim2.new(0.5, 0, -0.2, 0)
F_Level.Fragments.TextStrokeTransparency = 1

-- Frame Time
local F_Text2 = Instance.new("Frame")
F_Text2.Name = "Text2"
F_Text2.Parent = SlayerHub
...
player.PlayerGui.Main.Fragments:Clone().Parent = F_Text2
F_Text2.Fragments.TextColor3 = Color3.fromRGB(245, 245, 245)
F_Text2.Fragments.Text = ""
F_Text2.Fragments.Size = UDim2.new(1, 0, 0, 25)
F_Text2.Fragments.TextXAlignment = 'Center'
F_Text2.Position = UDim2.new(0.5, 0, -0.1, 0)
F_Text2.Fragments.TextStrokeTransparency = 1

-- Frame Name
local F_Text = Instance.new("Frame")
F_Text.Name = "Text"
F_Text.Parent = SlayerHub
...
player.PlayerGui.Main.Fragments:Clone().Parent = F_Text
F_Text.Fragments.TextColor3 = Color3.fromRGB(245, 245, 245)
F_Text.Fragments.Text = '( '..player.Name..' )'
F_Text.Fragments.Size = UDim2.new(1, 0, 0, 25)
F_Text.Fragments.TextXAlignment = 'Center'
F_Text.Position = UDim2.new(0.5, 0, 0.14, 0)
F_Text.Fragments.TextStrokeTransparency = 1

-- Frame Status
local F_Text3 = Instance.new("Frame")
F_Text3.Name = "Text3"
F_Text3.Parent = SlayerHub
...
player.PlayerGui.Main.Fragments:Clone().Parent = F_Text3
F_Text3.Fragments.TextColor3 = Color3.fromRGB(0, 255, 186)
F_Text3.Fragments.Text = 'Status: Farm Level.'
F_Text3.Fragments.Size = UDim2.new(1, 0, 0, 28)
F_Text3.Fragments.TextXAlignment = 'Center'
F_Text3.Position = UDim2.new(0.5, 0, 0.22, 0)
F_Text3.Fragments.TextStrokeTransparency = 1

-- Frame Sanguine Art
local F_Text4 = Instance.new("Frame")
F_Text4.Name = "Text4"
F_Text4.Parent = SlayerHub
...
player.PlayerGui.Main.Fragments:Clone().Parent = F_Text4
F_Text4.Fragments.TextColor3 = Color3.fromRGB(0, 255, 186)
F_Text4.Fragments.Text = '...'
F_Text4.Fragments.Size = UDim2.new(1, 0, 0, 35)
F_Text4.Fragments.TextXAlignment = 'Center'
F_Text4.Position = UDim2.new(0.5, 0, 0.47, 0)
F_Text4.Fragments.TextStrokeTransparency = 1

-- Frame Full Moon
local F_Text6 = Instance.new("Frame")
F_Text6.Name = "Text6"
F_Text6.Parent = SlayerHub
...
player.PlayerGui.Main.Fragments:Clone().Parent = F_Text6
F_Text6.Fragments.TextColor3 = Color3.fromRGB(255,140,0)
F_Text6.Fragments.Text = '🌕 75% ('..tostring(game:GetService("Lighting").TimeOfDay)..')'
F_Text6.Fragments.Size = UDim2.new(1, 0, 0, 25)
F_Text6.Fragments.TextXAlignment = 'Center'
F_Text6.Position = UDim2.new(0.5, 0, -0.03, 0)
F_Text6.Fragments.TextStrokeTransparency = 1

-- Blur effect
local BlurSlayer = Instance.new("BlurEffect")
BlurSlayer.Name = "SlayerBlur"
BlurSlayer.Parent = game:GetService("Lighting")
BlurSlayer.Enabled = true
BlurSlayer.Size = 0

-- Toggle Hub com botão
local Luna = Instance.new("ScreenGui")
Luna.Name = "Slayer Hub Toggle"
...
ToggleImgUi.Image = "rbxassetid://104989038209881"
...
Uitoggle.Text = "Slayer Hub Kaitun"
...
Yedhee.Position = UDim2.new(0.14, 0, 0.429, 0)
...
local Tabs = {
    Main = Window:AddTab({ Title = "General", Icon = "user-cog" }),
