...
-- Verifica qual mundo é
local chosenWorld = worldMap[placeId]
if chosenWorld then
    if chosenWorld == "World1" then
        World1 = true
    elseif chosenWorld == "World2" then
        World2 = true
    elseif chosenWorld == "World3" then
        World3 = true
    end
end
...
-- Função CheckQuest() vazia (como você pediu)
function CheckQuest()
